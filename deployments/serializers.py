...
class ProjectSerializer(TranslatedModelSerializerMixin, EnumSupportSerializerMixin, serializers.ModelSerializer):
    ...
    organizational_unit_display = serializers.CharField(source='get_organizational_unit_display', read_only=True)
    partner_display = serializers.CharField(source='get_partner_display', read_only=True)
    activity_display = serializers.CharField(source='get_activity_display', read_only=True)
    subactivity_display = serializers.CharField(source='get_subactivity_display', read_only=True)
    units_measurement_metric_display = serializers.CharField(source='get_units_measurement_metric_display', read_only=True)
    where_province_display = serializers.CharField(source='get_where_province_display', read_only=True)
